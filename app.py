...
from pipeline_comercial import tela_pipeline_comercial
...
if is_cliente:
    ...
    # --- MÓDULOS DE APOIO (MANTIDOS E INTEGRADOS) ---
        ...
        cnpj_cliente = proposta_atual.get("cnpj", "")
        responsavel_cliente = proposta_atual.get("responsavel", "")
        email_cliente = proposta_atual.get("email", "")
        telefone_cliente = proposta_atual.get("telefone", "")
    ...
    elif menu == "Pipeline Comercial":
        tela_pipeline_comercial(supabase)
